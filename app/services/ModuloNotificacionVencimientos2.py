...
def NotificarVencimientosListas(
        CONFIG: Dict[str, Any],
    ...
    clasif_sin = _clasificar_por_ventana(
        ListaNotificarLicenciasSinEmail,
        hoy_date,
        CAMPO_VENCIMIENTO
    )
    clasif_inv = _clasificar_por_ventana(
        ListaNotificarLincenciasComercialInactivos,
        hoy_date,
        CAMPO_VENCIMIENTO
    )
    ...
    if ListaNotificarLicenciasConEmail:
        ...
        for correo_lower, items in grupos.items():
            clasif_g = _clasificar_por_ventana(items, hoy_date, CAMPO_VENCIMIENTO)
    ...
    if acumulado_con_email:
        clasif_all = _clasificar_por_ventana(acumulado_con_email, hoy_date, CAMPO_VENCIMIENTO)
